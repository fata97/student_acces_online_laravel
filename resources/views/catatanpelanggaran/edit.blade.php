...
@section('judul')
<h1>
  Form Edit Catatan Pelanggaran
</h1>
<ol class="breadcrumb">
  <li><a href="{{ url('/beranda') }}"><i class="fa fa-dashboard"></i>Student Acces Online</a></li>
  <li class="active">Form Edit Catatan Pelanggaran</li>
</ol>
@endsection
          ...
          <form action="{{ url('/catatanpelanggaran') }}" method="POST" >
            ...
            <div class="form-group">
              <label for="tanggal">Tanggal*</label>
               <input type="text" name="tanggal" class="tanggal form-control" value="02-01-2018">
            </div>
            <div class="form-group">
							<label>Jam*</label>
							<input type="text" class="form-control" name="jam" placeholder="Jam" value="10:05">
						</div>
            <div class="form-group">
