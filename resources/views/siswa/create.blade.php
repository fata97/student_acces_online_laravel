...
<ol class="breadcrumb">
  ...
  <li class="active">Form Tambah Data Siswa</li>
</ol>
@endsection
      ...
      <div class="row">
        <div class="col-sm-5 col-md-5">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nis" placeholder="Nomor Induk Siswa" value="{{old('nis')}}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="ttl" placeholder="Tempat & Tgl Lahir" value="{{old('ttl')}}">
                @if($errors->has('ttl'))
                  <p>
          ...
          <div class="row">
            <div class="col-sm-5 col-md-5">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ttl_ayah" placeholder="tempat & Tgl Lahir" value="{{old('ttl_ayah')}}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="penghasilan_ayah" placeholder="Penghasilan Ayah" value="{{old('penghasilan_ayah')}}">
                ...
                <div class="col-sm-5 col-sm-offset-2 col-md-5 col-md-offset-2">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ttl_ibu" placeholder="tempat & Tgl Lahir Ibu" value="{{old('ttl_ibu')}}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="penghasilan_ibu" placeholder="Penghasilan ibu" value="{{old('penghasilan_ibu')}}">
