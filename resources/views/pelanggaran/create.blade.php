...
@section('judul')
<h1>
  Form Tambah Data Pelanggaran
</h1>
<ol class="breadcrumb">
  <li><a href="{{ url('/beranda') }}"><i class="fa fa-dashboard"></i>Student Acces Online</a></li>
  <li class="active">Form Tambah Data Pelanggaran</li>
</ol>
@endsection
        ...
        <div class="col-sm-5 col-md-5">
          <form action="{{ url('/pelanggaran') }}" method="POST" >
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nama_pelanggaran" placeholder="Nama Pelanggaran" value="{{old('nama_pelanggaran')}}">
							</div>
              <div class="form-group">
								<label>Poin*</label>
								<input type="text" class="form-control" name="poin" placeholder="Poin" value="{{old('poin')}}">
							</div>
            </div>
          </div>
